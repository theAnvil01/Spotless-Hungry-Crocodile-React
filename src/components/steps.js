          ...
          <div className="steps-section-header">
            ...
            <div className="steps-actions">
              <button className="thq-button-filled thq-button-animated steps-button">
                <span className="thq-body-small">Signup now</span>
              </button>
            </div>
          </div>
...
Steps.defaultProps = {
  step4Description:
    'Monitor your credit usage, scan results, and overall platform activity to stay informed and secure.',
  step3Description:
    'Start scanning websites to identify subdomains and assess vulnerabilities for enhanced security measures.',
  step1Title: 'Register for an Account',
  step1Description:
    'Sign up for a new account on our bug-hunting platform to access all features and services.',
  step2Title: 'Purchase Credits',
  step4Title: 'Track Progress',
  step2Description:
    'Buy credits to initiate scans for subdomain enumeration and vulnerability assessment on websites.',
  step3Title: 'Initiate Scans',
}
